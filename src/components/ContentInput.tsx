  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Upload multiple documents or paste content directly. Supports LaTeX for STEM content.</p>
      </div>
      ...
      <div className="mb-8 space-y-4">
        <h3 className="text-lg font-semibold text-gray-900">Or paste content directly:</h3>
        <input
          type="text"
        ...
        />
        <textarea
          placeholder="Paste your content here... LaTeX equations like $E = mc^2$ are supported."
          value={textInput}
        ...
        <button
          ...
          className="bg-green-600 text-white px-6 py-2 rounded-lg hover:bg-green-700 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed flex items-center space-x-2"
        >
